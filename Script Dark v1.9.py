...
def id():
    os.system('xdg-open https://m.youtube.com/channel/UCzqK0ZO3Iyjr8Q4JozBBiuA')
...
if sandi == 'AVATAR' and user == 'SUBREK':
    print '\x1b[92mEnte Berhasil Login'
    sys.exit
else:
    print '\x1b[91mYah karunya Login GAGAL, silakan hubungi gw'
    id()
    restart()
...
def pilih():
    ...
    if zedd == '':
        print '\x1b[1;91m[!] Jangan kosong coyy'
        pilih()
    elif zedd == '1':
        informasi()
    elif zedd == '2':
